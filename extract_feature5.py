...
DATASET_5_PATH = "dataset5/train"
OUTPUT_FILE    = "features_5.csv"


def extract_features(image_path):
    """Exactement la même fonction que dans le script d'origine."""
...
for class_name in os.listdir(DATASET_5_PATH):
    class_path = os.path.join(DATASET_5_PATH, class_name)
